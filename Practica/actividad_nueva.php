                            ...
                            <div class="card-body">
                                <div class="media-flex">
                                    ...
                                    <!--<p class="card-text" id="act_nombre"> Nombre</p>-->
                                        ...
                                        <p class="card-text" id="act_descripcion">Descripcion</p>
                ...
                <form class="needs-validation" novalidate> 
                    <div class="row g-3">
                        <div class="col">
                            ...
                            <input type="text" class="form-control" id="nombreActividad" onchange="copiaContenido(this,'act_nombre')" placeholder="taller de guitarra|curso mooc: Nombre del curso|XXX Congreso..." required>
                        ...
                        <div class="my-3">
                            <div class="form-check">
                                <input id="academico" name="categoria" onclick="copiaContenido (this,'act_categoria');" value="Academico" type="radio" class="form-check-input" checked required>
                                <label class="form-check-label" for="academico">Academica</label>
                            </div>
                            <div class="form-check">
                                <input id="extraesc" name="categoria" onclick="copiaContenido (this,'act_categoria');" value="Extraescolar" type="radio" class="form-check-input" required>
                                <label class="form-check-label" for="extraesc">Extra Escolar</label>
                            </div>
                            <div class="form-check">
                                <input id="tutoria" name="categoria" onclick="copiaContenido (this,'act_categoria');" value="Tutoria" type="radio" class="form-check-input" required>
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control" id="horario" onchange="copiaContenido(this,'act_horario')" placeholder="9AM-12PM |Libre" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-14">
                        <div class="input-group has-validation">
                            ...
                            <textarea class="form-control" id="descripcion" rows="3" input type="text" class="form-control" id="descripcion" onchange="copiaContenido(this,'act_descripcion')" placeholder="" required></textarea>
                           <!-- <input type="text" class="form-control" id="descripcion" onchange="copiaContenido(this,'act_descripcion')" placeholder="" required>-->
                            <div class="invalid-feedback">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="periodo" onchange="copiaContenido(this,'act_periodo')" placeholder="10 de enero de 2022 al 12 de febrero del 2022" required>
                        <div class="invalid-feedback">
                            Se requiere el lugar de la actividad Complementaria
                        </div>
                    </div>
                    <div class="col-3">
                        ...
                        <input type="number" min="1" class="form-control" id="cupo" onchange="copiaContenido(this,'act_cupo')" placeholder="" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control" id="material" onchange="copiaContenido(this,'act_material')" placeholder="" required>
                        <div class="invalid-feedback">
