...
<body>
  ...
  <div class="container">
    <div class="py-5 text-center">
      <tr>
        <h1>Profesores de Ingeniería en Gestión Empresarial</h1>
        <h4>Reyna popocat flores</h4>
        <p class="lead">El docente es buena honda o buen profesor con los alumnos y ayuda en todo lo que el pueda</p>

        <h4>Ariana raquel de la concha ruiz</h4>
        <p class="lead">La profesora da una buena materia y te da todo lo que llegas a necesitar para un futuro de herramientas que podrian servirte</p>

        <h4>Luis manuel garcia pizarro</h4>
        <p class="lead">El profesor t eayuda en todo lo que necesitas a si como tambien para que un futuro tengas las cosas que llegues a necesitar</p>

        <h4>Ulises valdez rodrigues</h4>
        <p class="lead">Es buena honda y va especificando de cada un de los trabajos que vayas dando</p>

        <h4>Arturo aquiles vazquez</h4>
        <p class="lead">El profesor arturo es un poco estricto en cuanto a entregar trabajos pero mientras el alumno le cumpla con eso te ayuda y es buena honda en cuanto a eso</p>

    </div>
    <div class="py-5">
        <a href="IGE.php"><h6><p class="lead"> <- Regresar </p></h6></a>
    </div>
  </div>
</body>
