  ...
  <nav class="navbar navbar-expand-md bg-dark navbar-dark py-3" hidden>
    ...
    <div class="container">
        <div class="py-5 text-center">
            <h1>Profesores de Ingeniería en Sistemas Computacionales</h1>
            <h4>Aquiles Ramos Gonzales</h4>
            <p class="lead">El profesor aquiles es extricto en cuanto a que aprendas pero el va explicando que es lo que hace cada parte del programa</p>

            <h4>Hilda Patricia Beltran Hernandez</h4>
            <p class="lead">La profesora hilda es buena en la materia y ella te explica como se debe en cada uno de los trabajos</p>

            <h4>Roberto Espinoza Torres</h4>
            <p class="lead">El profesor es bueno y te explica cada par te de las computadoras a si como de los componentes</p>

            <h4>Ana Salinas Hernandez</h4>
            <p class="lead">Es buena honda y va especificando de cada un de los trabajos que vayas dando</p>

            <h4>Maria Guadalupe Najera Lozano</h4>
        ...
        <div class="py-5">
            <a href="ISC.php"><h6><p class="lead"> <- Regresar </p></h6></a>
        </div>
    </div>
</body>
