...
<head>
    ...
    <div class="container">
        ...
        <h1>Profesores de Ingeniería en Tecnologías de la Información y Comunicaciones</h1>
        <h4>Pedro Cruz Vazques</h4>
        <p class="lead">El profesor es extricto en cuanto a que aprendas pero el va explicando que es lo que hace cada parte del programa</p>

        <h4>Adriana Carreon Gonzales</h4>
        <p class="lead">La profesora es buena en la materia y ella te explica como se debe en cada uno de los trabajos</p>

        <h4>Jose Carlos Hernandez Lozano</h4>
        <p class="lead">El profesor es bueno y te explica cada par te de las computadoras a si como de los componentes</p>

        <h4>Juan Ramon Olague Sanchez</h4>
        <p class="lead">Es buena honda y va especificando de cada un de los trabajos que vayas dando</p>

        <h4>Paula Garcia Vasquez de la Garza</h4>
        <p class="lead">La profesora da varias materias y en cada una se desenlaza como se debe y explica bien cada parte del tema</p>

        </div>
        <div class="py-5">
            <a href="ITIC.php"><h6><p class="lead"> <- Regresar </p></h6></a>
        </div>
    </div>
</body>
