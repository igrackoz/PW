...
<body>
  ...
  <div class="d-flex justify-content-center">
    <form action="userAuth.php">
			...
			<br>
			<div class="row">
        <div class="col"><label for="email" class=""> <p class="lead">email</p></label></div>
        <div class="col"><input type="email" class="" id="inputemail" aria-describedby="ayudaemail"></div>
			</div>
			<br>
			<div class="row">
        <div class="col" id="ayudaemail"><p class="lead">nunca compartiremos el email con nadie</p></div>
			</div>
			<div class="row">
        <div class="col"><label for="Password" class=""><p class="lead">Contraseña</p></label></div>
        <div class="col"><input type="password" class="" id="inputpassowrd"></div>
			</div>
      	<div class="col"><input type="submit" class="" value="Submit"></div>
			</div>
    </form>
  </div>
</body>
